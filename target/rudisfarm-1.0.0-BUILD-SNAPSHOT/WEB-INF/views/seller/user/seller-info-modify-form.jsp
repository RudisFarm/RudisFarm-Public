	                            ...
	                            <div class="card-body card-block">
	                                <form id="sellerModifyForm" enctype="multipart/form-data" class="form-horizontal">
	                                    ...
	                                    <div class="row form-group">
	                                        ...
	                                        <div class="col-12 col-md-9">
	                                            <input type="email" id="NAME" name="NAME" placeholder="업체명" class="form-control" value="${resultUserVO.getNAME()}">
	                                        </div>
	                                    </div>
	                                    <div class="row form-group">
	                                        <div class="col col-md-3">
	                                        ...
	                                        <div class="col-12 col-md-9">
	                                            <input type="email" id="FIR_ADDRESS" name="FIR_ADDRESS" placeholder="주소" class="form-control" value="${resultUserVO.getFIR_ADDRESS()}">
	                                            <input type="email" id="SEC_ADDRESS" name="SEC_ADDRESS" placeholder="상세 주소" class="form-control" value="${resultUserVO.getSEC_ADDRESS()}">
	                                        </div>
	                                    </div>
	                                    <div class="row form-group">
	                                        <div class="col col-md-3">
	                                        ...
	                                        <div class="col-12 col-md-9">
	                                            <input type="email" id="PHONE" name="PHONE" placeholder="전화번호" class="form-control" value="${resultUserVO.getPHONE()}">
	                                        </div>
	                                    </div>
	                                    <div class="row form-group">
	                                        <div class="col col-md-3">
