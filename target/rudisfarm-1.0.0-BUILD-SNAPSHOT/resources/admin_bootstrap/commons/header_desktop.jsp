                ...
                <div></div>
                    ...
                    <div class="account-wrap">
                        <div class="account-item clearfix js-item-menu">
                            ...
                            <div class="content">
                                <a class="js-acc-btn" href="#">${admin.USER_ID }</a>
                            </div>
                            <div class="account-dropdown js-dropdown">
                                <div class="info clearfix">
                                    <div class="image">
                                        <a href="/rudisfarm/admin-info">
                                            <img src="<%= request.getContextPath() %>/resources/images/images.jpg" alt="Admin" />
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h5 class="name">
                                            <a href="/rudisfarm/admin-info">${admin.NAME }</a>
                                        </h5>
                                        <span class="email">이메일 : ${admin.EMAIL }</span>
                                    </div>
                                </div>
