...
public class CardAPIVO {
	...
	public String toString() {
		return "CardAPIVO [purchase_corp=" + purchase_corp + ", purchase_corp_code=" + purchase_corp_code
				+ ", issuer_corp=" + issuer_corp + ", issuer_corp_code=" + issuer_corp_code
				...
				+ card_mid + ", interest_free_install=" + interest_free_install + ", card_item_code=" + card_item_code
				+ "]";
	}
}
