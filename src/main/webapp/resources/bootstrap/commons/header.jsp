...
<header id="header" class="header header-desktop header-2">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-3">
				<a class="page-title-sub text-center" style="text-transform: none; text-decoration: none;" href="<%= request.getContextPath() %>" id="logo">
					RudisFarm
							...
							<c:when test="${not empty USER_ID}">
								<div class="mini-cart-wrap">
									...
									<div class="widget-shopping-cart-content">
										...
										<p class="total">
											<strong>총합 금액 : </strong> 
											<span class="amount"><fmt:formatNumber value="" pattern="#,###,###" />원</span>
										</p>
										<p class="buttons">
		...
		<div class="row">
			...
			<div class="col-xs-8">
				<div class="header-center">
					<a class="page-title text-center" style="color: black; font-size: 40px" href="<%= request.getContextPath() %>" id="logo">
						RudisFarm
<%-- 						<img class="logo-image" src="<%= request.getContextPath() %>/resources/bootstrap/images/logo.png" alt="Organik Logo" /> --%>
					</a>
				</div>
			...
			<div class="col-xs-2">
				<div class="header-right">
					...
					<c:when test="${not empty USER_ID}">
					<div class="mini-cart-wrap">
						<a href="<%= request.getContextPath() %>/my-page/my-cart">
							<div class="mini-cart">
								<div class="mini-cart-icon" data-count="">
									<i class="ion-bag"></i>
								</div>
