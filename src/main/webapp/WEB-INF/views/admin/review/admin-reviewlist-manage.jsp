	...
	<script type="text/javascript">
		$(function() {
			$('#sort').change(function() {
				location.href='/rudisfarm/admin/admin-reviewlist-manage?sort='+$(this).val();
			});
		});
	</script>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12">
								...
								<form action="/rudisfarm/admin/admin-reviewlist-manage">
						            <div class="row">
                                    ...
                                    <c:if test="${reviewPagenation.getList().size() ne 0}">
                                        ...
                                        <tbody>
											...
											<tr class="tr-shadow" onclick="location.href='admin-review-manage/${review.REVIEW_ID}'" style="cursor: pointer">
                                        		<td>
                                        			<div class="row p-2">
                                        			...
                                        			<div class="row p-2">
                                        				<div class="col-sm-12 col-md-12 col-lg-6 p-1">
                                        					<div class="row p-3">
                                        						...
                                        						<div class="col-sm-12 col-md-4 col-lg-4 p-1" onclick="event.cancelBubble=true; location.href='/rudisfarm/admin/admin-product-manage/${review.PRODUCT_ID}'" style="cursor:pointer; color:red">
		                                 ...
		                                 <ul class="pagination">
											<c:if test="${fn:length(reviewPagenation.getList()) > 0}">
												<c:choose>
													...
													<c:otherwise>
														<li class="page-item"><a class="page-link" href="/rudisfarm/admin/admin-reviewlist-manage?page=${reviewPagenation.startPage-1}${keywordTypeUrl}${keywordUrl}${sortUrl}">이전</a></li>
													</c:otherwise>
												</c:choose>
												<c:forEach var="currentPage" begin="${reviewPagenation.startPage}" end="${reviewPagenation.endPage}">
													<c:choose>
														...
														<c:otherwise>
															<li class="page-item"><a class="page-link" href="/rudisfarm/admin/admin-reviewlist-manage?page=${currentPage}${keywordTypeUrl}${keywordUrl}${sortUrl}">${currentPage}</a></li>
														</c:otherwise>
													</c:choose>
												</c:forEach>
												...
												<c:choose>
													...
													<c:otherwise>
														<li class="page-item"><a class="page-link" href="/rudisfarm/admin/admin-reviewlist-manage?page=${reviewPagenation.endPage+1}${keywordTypeUrl}${keywordUrl}${sortUrl}">다음</a>
													</c:otherwise>
												</c:choose>
											</c:if>
									    </ul> 
