...
<!-- 							<div class="table-mobile">모바일 테이블</div> -->
							 <div class="table-desktop">
								<table class="table table-borderless table-data3" style="word-break:keep-all;">
									...
									<c:forEach var="superAdminPaymentList" items="${paymentPagenation.superAdminPaymentList}">
										<tbody>
											<tr>
												<td>${superAdminPaymentList.TID}</td>
												<td>${superAdminPaymentList.AID}</td>
												<td>${superAdminPaymentList.STATUS}</td>
												<td>${superAdminPaymentList.PARTNER_ORDER_ID}</td>
												<td>${superAdminPaymentList.PARTNER_USER_ID}</td>
												<td>${superAdminPaymentList.ITEM_NAME}</td>
												<td>${superAdminPaymentList.QUANTITY}</td>
												<td>${superAdminPaymentList.TOTAL_AMOUNT}</td>
												<td>${superAdminPaymentList.VAT_AMOUNT}</td>
												<td>${superAdminPaymentList.PAYMENT_METHOD_TYPE}</td>
												<td>${superAdminPaymentList.CANCEL_AMOUNT}</td>
												<td>${superAdminPaymentList.APPROVED_AT}</td>
											</tr>
										</tbody>
									</c:forEach>
								</table>
									...
									<tbody>
										<tr>
										 <td>
										  ...
										  <td>
										  	${superAdminPaymentList.PARTNER_ORDER_ID}<br>
											${superAdminPaymentList.STATUS}<br>
											${superAdminPaymentList.PARTNER_USER_ID}<br>
											${superAdminPaymentList.ITEM_NAME}<br>
											${superAdminPaymentList.QUANTITY}<br>
											${superAdminPaymentList.TOTAL_AMOUNT}<br>
											${superAdminPaymentList.CANCEL_AMOUNT}<br>
											${superAdminPaymentList.APPROVED_AT}<br>
										  </td>
										</tr>
									</tbody>
								  </c:forEach>
