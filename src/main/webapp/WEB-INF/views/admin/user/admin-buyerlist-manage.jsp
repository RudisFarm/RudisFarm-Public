	...
	<script type="text/javascript">
		$(function() {
			$('#sort').change(function() {
				location.href='/rudisfarm/admin/admin-buyerlist-manage?sort='+$(this).val();
			});
		});
	</script>
            	...
            	<div class="section__content section__content--p30">
                	<div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h2 class="title-7 m-b-35">구매자 목록</h2>
                                <!-- 필터링 및 검색 시작 -->
								<form action="/rudisfarm/admin/admin-buyerlist-manage">
					            <div class="row">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    ...
                                    <c:if test="${sellerPagenation.getList().size() ne 0}">
                                        ...
                                        <tbody>
											...
											<tr class="tr-shadow" onclick="location.href='admin-buyer-manage/${seller.getUSER_ID()}?prevPage=${sellerPagenation.getPage()}${keywordTypeUrl}${keywordUrl}${sortUrl}'" style="cursor:pointer;">
                                        		<td>
                                        			<div class="row p-2">
		                                 ...
		                                 <ul class="pagination">
											<c:if test="${fn:length(sellerPagenation.getList()) > 0}">
												<c:choose>
													...
													<c:otherwise>
														<li class="page-item"><a class="page-link" href="/rudisfarm/admin/admin-buyerlist-manage?page=${sellerPagenation.startPage-1}${keywordTypeUrl}${keywordUrl}${sortUrl}">이전</a></li>
													</c:otherwise>
												</c:choose>
												<c:forEach var="currentPage" begin="${sellerPagenation.startPage}" end="${sellerPagenation.endPage}">
													<c:choose>
														...
														<c:otherwise>
															<li class="page-item"><a class="page-link" href="/rudisfarm/admin/admin-buyerlist-manage?page=${currentPage}${keywordTypeUrl}${keywordUrl}${sortUrl}">${currentPage}</a></li>
														</c:otherwise>
													</c:choose>
												</c:forEach>
												...
												<c:choose>
													...
													<c:otherwise>
														<li class="page-item"><a class="page-link" href="/rudisfarm/admin/admin-buyerlist-manage?page=${sellerPagenation.endPage+1}${keywordTypeUrl}${keywordUrl}${sortUrl}">다음</a>
													</c:otherwise>
												</c:choose>
											</c:if>
									    </ul> 
