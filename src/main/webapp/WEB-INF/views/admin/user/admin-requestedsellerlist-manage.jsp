				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12">
								<!-- DATA TABLE -->
								<h3 class="title-5 m-b-35">판매자 가입 요청 목록</h3>
											...
											<c:forEach begin="1" end="15" varStatus="loop">
												<tr class="tr-shadow">
													...
													<button class="au-btn au-btn--block au-btn--green m-b-20"
															onclick="location.href='admin-requestedseller-manage/${loop.count}'">첫번째</button>
													</td>
								...
								<input class="btn btn-success btn-sm" type="button" value="승인" onclick="" style="float: right; margin-right:10px">
							</div>
						</div>
					</div>
				</div>
