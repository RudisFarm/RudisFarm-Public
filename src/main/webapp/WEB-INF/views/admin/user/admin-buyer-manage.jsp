							...
							<div class="col-lg-12">
								<div class="card">
									...
									<div class="card-body card-block">
										...
										<div class="row form-group">
											<div class="col col-md-3">유저 이메일</div>
											<div class="col-12 col-md-9">
												${buyer.EMAIL } <br>
											</div>
										</div>
										<div class="row form-group">
											<div class="col col-md-3">유저명</div>
											<div class="col-12 col-md-9">
												${buyer.USER_NAME } <br>
											</div>
										</div>
										<div class="row form-group">
											<div class="col col-md-3">주소</div>
											<div class="col-12 col-md-9">
												${buyer.FIR_ADDRESS } <br>
											</div>
										</div>
										<div class="row form-group">
											<div class="col col-md-3"></div>
											<div class="col-12 col-md-9">
												${buyer.SEC_ADDRESS } <br>
											</div>
										</div>
										<div class="row form-group">
											<div class="col col-md-3">전화번호</div>
											<div class="col-12 col-md-9">
												${buyer.PHONE } <br>
											</div>
										</div>
										<div class="row form-group">
											<div class="col col-md-3">가입일</div>
											<div class="col-12 col-md-9">
												${buyer.JOINDATE } <br>
											</div>
										</div>
										<div class="row form-group">
											<div class="col col-md-3">생년월일</div>
											<div class="col-12 col-md-9">
												${buyer.BIRTHDATE } <br>
											</div>
										</div>
										<div class="row form-group">
											<div class="col col-md-3">성별</div>
											<div class="col-12 col-md-9">
												${buyer.GENDER } <br>
											</div>
										</div>
										<div class="row form-group">
											<div class="col col-md-3">LEVEL</div>
											<div class="col-12 col-md-9">
												${buyer.LEVEL } <br>
											</div>
										</div>
										...
										<div class="row form-group">
											<div class="col col-md-3">PLATFORM</div>
											<div class="col-12 col-md-9">
												${buyer.PLATFORM } <br>
											</div>
										</div>
