							...
							<div class="col-lg-12">
								<div class="card">
									...
									<div class="card-body card-block">
										...
										<div class="row form-group">
											<div class="col col-md-3">판매자 아이디</div>
											<div class="col-12 col-md-9">
												${name } <br>
											</div>
										</div>
										...
										<div class="row form-group">
											<div class="col col-md-3">가격</div>
											<div class="col-12 col-md-9">
												${name } <br>
											</div>
										</div>
										<div class="row form-group">
											<div class="col col-md-3">대분류</div>
											<div class="col-12 col-md-9">
												${name } <br>
											</div>
										</div>
										<div class="row form-group">
											<div class="col col-md-3">상세 설명 및 사진</div>
											<div class="col-12 col-md-9">
												${name }
												<!-- <small class="form-text text-muted">-없이 입력하세요.</small> -->

												<br> <br> <small class="form-text text-muted">기타
													등등?</small>
											</div>
										</div>
									</div>
