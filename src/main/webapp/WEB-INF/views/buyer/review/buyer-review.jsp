			...
			<div id="main">
				<div class="section section-bg-10 pt-11 pb-17">
					<div class="container">
						<div class="row">
							<div class="col-sm-12">
								<h2 class="page-title text-center">리뷰 작성</h2>
							</div>
						</div>
					</div>
				</div>
...
<!-- 														<input type="file" id="reviewfiles" name="reviewfiles" multiple> -->
																...
																<div class="col-md-12">
																<h3 class="comment-title">리뷰 등록</h3>
																	<label>리뷰 내용</label>
																	<textarea id="CONTENT" name="CONTENT" rows="5" placeholder="Review" required maxlength="1000" style="width:100%;"></textarea>
																</div>
