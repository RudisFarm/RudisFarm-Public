			...
			<div id="main">
				<div class="section section-bg-10 pt-11 pb-17">
					<div class="container">
						<div class="row">
							<div class="col-sm-12">
								<h2 class="page-title text-center">Payment Cancel</h2>
							</div>
						</div>
					</div>
				</div>
										...
										<tbody>
											<tr class="cart_item" align="center">
												...
												<td class="product-info">
													...
													<span class="sub-title"><fmt:formatDate value="${info.canceled_at}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
													<span class="amount">수량 ${info.quantity} 개</span>
												</td>
												<td class="product-subtotal">
													<span class="color">${info.canceled_amount.total}원</span>
												</td>
												<td class="product-stock">
													<span class="color">${info.status}</span>
												</td>
												<td>&nbsp;</td>
											</tr>
										</tbody>
