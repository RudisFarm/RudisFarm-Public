		...
		<div class="site">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="text-center">
									<img src="<%= request.getContextPath() %>/resources/bootstrap/images/background/payment-failed.png" class="mb-6" alt="" />
									<h3 class="error-title uppercase">현재 이 페이지는 이미 만료된 페이지입니다.</h3>
									<h3 class="error-title uppercase">이 페이지는 더 이상 제공되지 않습니다.</h3>
									<a class="color" style="font-size:xx-large;" href="/rudisfarm">인덱스로 돌아가기</a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="copyright">
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							Copyright © 2021 <a href="#">RudisFarm Store</a> - All Rights Reserved.
						</div>
						<div class="col-md-4">
