...
<script>
	$(document).ready(function(){
		...
		function updateOrdersStatus(status) {
			$.ajax({
				url: "${pageContext.request.contextPath}/seller/seller-reqexchangecompleted-manage",
				type: "PUT",
				dataType: 'json',
...
// 						location.reload();
		...
		$('#exchangeFButton').click(function(){
			console.log('교환 불가 버튼 클릭시 url 이동.');
							...
							<div class="col-md-12">
								...
								<div class="user-data m-b-30">
									<h3 class="title-3 m-b-30">
										<i class="zmdi zmdi-account-calendar"></i>교환 요청 내용
									</h3>
									...
									<div class="user-data__footer">
										<!--  <button class="au-btn au-btn-load" onclick="location.href='../seller-reqexchangecompleted-manage/${orders.ORDERS_NAME}'">교환 완료</button>-->
											<button class="au-btn au-btn-load" id="exchangeTButton">교환 처리</button>&nbsp;
											<button class="au-btn au-btn-load" id="exchangeFButton">교환 불가</button>
									</div>
