				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						<div class="row m-t-30">
							...
							<div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">교환 요청 목록</h3>
                                ...
                                <div class="table-responsive table-responsive-data2">
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
                                                <td><a href="/rudisfarm/seller/seller-reqexchangeOrders-manage/exchangedetail/${payment.ORDERS_NAME}">${payment.ORDERS_NAME}</a></td>
                                                <td>
 									...
 									<ul style = " margin: auto; width: 97%;" class="pagination">
										<c:choose>
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item"><a class="page-link" href="/rudisfarm/seller/seller-reqexchangeOrders-manage?page=${ordersPagenation.page-1}">이전</a></li>
												</c:otherwise>
											</c:choose>
											...
											<c:forEach var="startNum" begin="${ordersPagenation.startPage}" end="${ordersPagenation.endPage}">
												<c:choose>
													...
													<c:otherwise>
														<li class="page-item"><a class="page-link" href="/rudisfarm/seller/seller-reqexchangeOrders-manage?page=${startNum}">${startNum}</a></li>
													</c:otherwise>
												</c:choose>
											</c:forEach>
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item"><a class="page-link" href="/rudisfarm/seller/seller-reqexchangeOrders-manage?page=${ordersPagenation.endPage}">다음</a>
												</c:otherwise>
											</c:choose>
										</c:when>
											<c:otherwise>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                <a href="/rudisfarm/seller/seller-reqexchangeOrders-manage/exchangedetail/${payment.ORDERS_NAME}">${payment.ORDERS_NAME} </a><br>
