							...
							<div class="col-md-12">
								...
								<input type="hidden" id="sort" value="${paymentPagenation.sort}">
									...
									<form action="getSearchPaymentList" method="post">
										...
										<div class="col-md-12">
			                                <!-- DATA TABLE -->
			                                <h3 class="title-5 m-b-35">배송 처리 목록</h3>
			                                ...
			                                <div class="table-responsive table-responsive-data2">
			                                    <table class="table table-data2">
			                                        ...
			                                        <tbody>
			                                            <tr class="tr-shadow">
			                                                <td><a href="/rudisfarm/seller/seller-deliverylist-manage/deliverylistdetail/${payment.ORDERS_NAME}/${payment.TRACKING_NUMBER}">${payment.ORDERS_NAME}</a></td>
 									...
 									<ul style = " margin: auto; width: 97%;" class="pagination">
										<c:choose>
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item"><a class="page-link" href="/rudisfarm/seller/seller-deliverylist-manage?page=${ordersPagenation.page-1}">이전</a></li>
												</c:otherwise>
											</c:choose>
											...
											<c:forEach var="startNum" begin="${ordersPagenation.startPage}" end="${ordersPagenation.endPage}">
												<c:choose>
													...
													<c:otherwise>
														<li class="page-item"><a class="page-link" href="/rudisfarm/seller/seller-deliverylist-manage?page=${startNum}">${startNum}</a></li>
													</c:otherwise>
												</c:choose>
											</c:forEach>
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item"><a class="page-link" href="/rudisfarm/seller/seller-deliverylist-manage?page=${ordersPagenation.endPage}">다음</a>
												</c:otherwise>
											</c:choose>
										</c:when>
											<c:otherwise>
			                                    ...
			                                    <table class="table table-data2">
			                                        ...
			                                        <tbody>
			                                            <tr class="tr-shadow">
			                                                ...
			                                                <td>
				                                                <a href="/rudisfarm/seller/seller-deliverylist-manage/deliverylistdetail/${payment.ORDERS_NAME}/${payment.TRACKING_NUMBER}">${payment.ORDERS_NAME} </a><br>
				                                                ...
				                                                <span>${payment.TRACKING_NUMBER}</span><br>
