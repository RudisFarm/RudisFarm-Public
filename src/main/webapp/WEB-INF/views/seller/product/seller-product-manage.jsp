	...
	<script>
		function deleteProduct(product_id){
			if(confirm("정말로 삭제 하시겠습니까?")) {
				$.ajax({
					type: 'delete',
					url: 'seller-product-manage/'+product_id, 
					dataType: 'json',
                                    ...
                                    <div class="row">
										<div class="col-sm-12 col-md-12 col-lg-12">
	                                    	<div class="row">
				                                ...
				                                <div class="col-3 pl-0">
		                                        <button class="btn btn-success btn-block" onclick="location.href='/rudisfarm/seller/seller-product-manage-add-form'" >
		                                        <i class="zmdi zmdi-plus"></i>상품 등록</button>
		                                        </div>
		                                    </div>
	                                	</div>
                                	</div>
			                                        		...
			                                        		<td>
			                                        			<div class="row p-2">
			                                        				<div class="col-sm-12 col-md-12 col-lg-6 p-1">
			                                        					<div class="row p-2" style="cursor:pointer;" onclick="location.href='/rudisfarm/seller/seller-product-manage/${product.PRODUCT_ID}'">
			                                        			...
			                                        			<div class="row p-2">
			                                        				...
			                                        				<div class="col-sm-12 col-md-12 col-lg-6 p-1">
			                                        					<div class="row p-2">
			                                        						<div class="col-sm-12 col-md-6 col-lg-6 p-1" style="cursor:pointer;" onclick="location.href='/rudisfarm/seller/seller-product-manage/${product.PRODUCT_ID}'">
			                                        							<strong>판매 단위</strong><br>${product.WEIGHT / 1000}kg
			                                        						</div>
			                                        						<div class="col-sm-12 col-md-6 col-lg-6 p-1">
			                                        							<div class="table-data-feature">
							                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="수정" onclick="location.href='/rudisfarm/seller/seller-product-manage-update-form/${product.PRODUCT_ID}'">
                                    ...
                                    <ul class="pagination" style="justify-content:center;">
										<c:choose>
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item"><a class="page-link" href="/rudisfarm/seller/seller-product-manage?page=${productPagenation.page-1}&keyword=${productPagenation.keyword}&type1=${productPagenation.type1}&type2=${productPagenation.type2}&sort=${productPagenation.sort}">이전</a></li>
												</c:otherwise>
											</c:choose>
											...
											<c:forEach var="startNum" begin="${productPagenation.startPage}" end="${productPagenation.endPage}">
												<c:choose>
													...
													<c:otherwise>
														<li class="page-item"><a class="page-link" href="/rudisfarm/seller/seller-product-manage?page=${startNum}&keyword=${productPagenation.keyword}&type1=${productPagenation.type1}&type2=${productPagenation.type2}&sort=${productPagenation.sort}">${startNum}</a></li>
													</c:otherwise>
												</c:choose>
											</c:forEach>
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="page-item"><a class="page-link" href="/rudisfarm/seller/seller-product-manage?page=${productPagenation.page+1}&keyword=${productPagenation.keyword}&type1=${productPagenation.type1}&type2=${productPagenation.type2}&sort=${productPagenation.sort}">다음</a>
												</c:otherwise>
											</c:choose>
										</c:when>
											<c:otherwise>
