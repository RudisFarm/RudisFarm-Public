...
<head>
	...
	google.charts.setOnLoadCallback(drawChart);
	 		...
	 		document.getElementById("donutchart").innerHTML="판매된 상품이 없어 그래프를 출력할 수 없습니다.";
	 	 }
	}
	</script>
</head>
														...
														<div class="col-sm-12">
															...
															<div class="accordion" id="accordion4">
																<div class="accordion-group toggle">
																	...
																	<div id="collapse10" class="accordion-body collapse show" style=" background-color:#f5f3f0;">
