	                                    ...
	                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" id="addProductForm">
	                                     	<div class="row form-group">
	                                            <div class="col col-md-3">
	                                                <label class=" form-control-label">상품 번호</label>
	                                            </div>
	                                            <div class="col-12 col-md-9">
	                                                <p class="form-control-static"><strong>${product.PRODUCT_ID}</strong></p>
	                                            </div>
	                                        ...
	                                        <div class="row form-group">
	                                            ...
	                                            <div class="col-12 col-md-5">
	                                                <input type="text" name="PRODUCT_NAME" id="PRODUCT_NAME" placeholder="제목..." class="form-control" value="${product.PRODUCT_NAME}">
	                                        ...
	                                        <div class="row form-group">
	                                            ...
	                                            <div class="col-12 col-md-5">
	                                                <input type="text" id="PRICE" name="PRICE" placeholder="가격..." class="form-control" value="${product.PRICE}" onkeyup="inputNumberFormat(this)">
	                                        ...
	                                        <div class="row form-group">
	                                            ...
	                                            <div class="col-12 col-md-5">
	                                                <input type="text" name="WEIGHT" id="WEIGHT" placeholder="판매 단위..." class="form-control" value="${product.WEIGHT}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
	                                        ...
	                                        <div class="row form-group">
	                                            ...
	                                            <div class="col-12 col-md-5">
	                                                <input type="text" name="COUNT" id="COUNT" placeholder="수량..." class="form-control" value="${product.COUNT}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
	                                        ...
	                                        <div class="row form-group">
	                                            ...
	                                            <div class="col-12 col-md-7">
	                                                <textarea name="DESCRIPTION" id="DESCRIPTION" cols="40" rows="10" placeholder="상품 설명 (1500자)..." class="form-control" style="resize: none;" wrap="hard">${product.DESCRIPTION}</textarea>
	                                        	</div>
	                                        </div>
	                                        <div class="row form-group">
	                                            <div class="col col-md-3">
	                                            ...
	                                            <input type="hidden" name="TYPE1" value="${product.TYPE1}">
	                                        </div>
	                                        <div class="row form-group">
	                                            <div class="col col-md-3">
	                                            ...
	                                            <input type="hidden" name="TYPE2" value="${product.TYPE2}">
<!-- 	                                            <input type="hidden" name="PRICE_PER_GRAM" id="PRICE_PER_GRAM"> -->
	                                        ...
	                                        <div class="row form-group">
	                                            ...
	                                            <div class="col-12 col-md-9">
	                                                <input type="file" name="thum-image" id="thum-image" class="form-control-file">
	                                            </div>
	                                        </div>
	                                        ...
	                                        <div class="row form-group">
	                                            ...
	                                            <div class="col-12 col-md-9">
	                                                <input type="file" name="desc-image" id="desc-image" multiple="multiple" class="form-control-file">
	...
	<script>
		$(function() {
			...
			$("#productAddButton").click(function(event) {
				...
				$.ajax({
					type: 'post',
					url: '/rudisfarm/seller/seller-product-manage/${product.PRODUCT_ID}',
					...
					success: function(data) {
						if(data) {
							console.log(data);
							alert("수정에 성공했습니다.");
							location.href = "/rudisfarm/seller/seller-product-manage";
						} else {
